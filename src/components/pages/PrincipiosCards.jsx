  ...
  return (
    <CardPrinciples>
      ...
      <Container className=".principles-title-vision">
        ...
        <p>
          Permanecer sendo um grupo diverso, realizando o acompanhamento
          temporário das Instituições de Longa Permanência e adotando o maior
          número de vovôs e vovós ao longo desse caminho.
        </p>
      </Container>
      <Container className="principiosCards-container">
        <h3 className=".principles-title-value">VALORES</h3>
        <p>
          Prezar sempre pela a civilidade e cordialidade na relação voluntário x
          idoso, voluntário x voluntário. Respeitar as diversidades sociais,
          raciais, de gênero, de crença e orientação sexual, de cada idoso e/ou
          voluntário.
        </p>
      </Container>
    </CardPrinciples>
